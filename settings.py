...
configs['mqtt']['base_topic'] = b'controller/02'
configs['mqtt']['base_topic_subscribe'] = b'controller/02/input/#'
configs['mqtt']['base_topic_status'] = b'controller/02'
